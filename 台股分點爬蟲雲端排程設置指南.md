...
* `RECEIVER_EMAIL`：收件信箱（例如 `your-email@example.com`）
...
30 20 * * 1-5 cd /opt/stock_crawler && SMTP_USER="your@gmail.com" SMTP_PASSWORD="app-password" RECEIVER_EMAIL="your-email@example.com" /opt/stock_crawler/venv/bin/python stock_crawler_coordinator.py --market all --max-rounds 5 --no-excel >> /var/log/stock_crawler.log 2>&1
```
